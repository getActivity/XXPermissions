...
final class PermissionChecker {
     ...
     * 检查传入的权限是否符合要求
     */
    static void checkPermissionList(@NonNull Activity activity, @Nullable List<IPermission> requestPermissions, @Nullable AndroidManifestInfo androidManifestInfo) {
     ...
     * 检查权限序列化实现是否没问题
     */
    static void checkPermissionParcelable(@NonNull IPermission permission) {
