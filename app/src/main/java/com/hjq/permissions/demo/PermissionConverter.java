...
final class PermissionConverter {
    ...
    static {
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_EXTERNAL_STORAGE, R.string.common_permission_storage);
        PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_EXTERNAL_STORAGE, R.string.common_permission_storage);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_storage, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.READ_MEDIA_IMAGES, R.string.common_permission_image_and_video);
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_MEDIA_VIDEO, R.string.common_permission_image_and_video);
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_MEDIA_VISUAL_USER_SELECTED, R.string.common_permission_image_and_video);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_image_and_video, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.READ_MEDIA_AUDIO, R.string.common_permission_music_and_audio);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_music_and_audio, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.CAMERA, R.string.common_permission_camera);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_camera, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.RECORD_AUDIO, R.string.common_permission_microphone);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_microphone, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.ACCESS_FINE_LOCATION, R.string.common_permission_location);
        PERMISSION_NAME_MAP.put(PermissionConstants.ACCESS_COARSE_LOCATION, R.string.common_permission_location);

        // 注意：在 Android 12 的时候，蓝牙相关的权限已经归到附近设备的权限组了，但是在 Android 12 之前，蓝牙相关的权限归属定位权限组
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S)  {
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_SCAN, R.string.common_permission_nearby_devices);
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_CONNECT, R.string.common_permission_nearby_devices);
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_ADVERTISE, R.string.common_permission_nearby_devices);
            // 注意：在 Android 13 的时候，WIFI 相关的权限已经归到附近设备的权限组了，但是在 Android 13 之前，WIFI 相关的权限归属定位权限组
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU)  {
                PERMISSION_NAME_MAP.put(PermissionConstants.NEARBY_WIFI_DEVICES, R.string.common_permission_nearby_devices);
                ...
                PERMISSION_NAME_MAP.put(PermissionConstants.NEARBY_WIFI_DEVICES, R.string.common_permission_location);
                PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_nearby_devices, R.string.common_permission_description_demo);
                PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_location, R.string.common_permission_description_demo);
            }
        } else {
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_SCAN, R.string.common_permission_location);
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_CONNECT, R.string.common_permission_location);
            PERMISSION_NAME_MAP.put(PermissionConstants.BLUETOOTH_ADVERTISE, R.string.common_permission_location);
            PERMISSION_NAME_MAP.put(PermissionConstants.NEARBY_WIFI_DEVICES, R.string.common_permission_location);
            PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_location, R.string.common_permission_description_demo);
        }

        PERMISSION_NAME_MAP.put(PermissionConstants.ACCESS_BACKGROUND_LOCATION, R.string.common_permission_location_background);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.BODY_SENSORS, R.string.common_permission_body_sensors);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_body_sensors, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.BODY_SENSORS_BACKGROUND, R.string.common_permission_body_sensors_background);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_PHONE_STATE, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.CALL_PHONE, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.ADD_VOICEMAIL, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.USE_SIP, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_PHONE_NUMBERS, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.ANSWER_PHONE_CALLS, R.string.common_permission_phone);
        PERMISSION_NAME_MAP.put(PermissionConstants.ACCEPT_HANDOVER, R.string.common_permission_phone);
        // 注意：在 Android 9.0 的时候，读写通话记录权限已经归到一个单独的权限组了，但是在 Android 9.0 之前，读写通话记录权限归属电话权限组
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P)  {
            PERMISSION_NAME_MAP.put(PermissionConstants.READ_CALL_LOG, R.string.common_permission_call_logs);
            PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_CALL_LOG, R.string.common_permission_call_logs);
            PERMISSION_NAME_MAP.put(PermissionConstants.PROCESS_OUTGOING_CALLS, R.string.common_permission_call_logs);
            ...
            PERMISSION_NAME_MAP.put(PermissionConstants.READ_CALL_LOG, R.string.common_permission_phone);
            PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_CALL_LOG, R.string.common_permission_phone);
            PERMISSION_NAME_MAP.put(PermissionConstants.PROCESS_OUTGOING_CALLS, R.string.common_permission_phone);
            // 需要注意：这里的电话权限需要补充一下前面三个通话记录权限的用途
            PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_phone, R.string.common_permission_description_demo);
        }

        PERMISSION_NAME_MAP.put(PermissionConstants.GET_ACCOUNTS, R.string.common_permission_contacts);
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_CONTACTS, R.string.common_permission_contacts);
        PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_CONTACTS, R.string.common_permission_contacts);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_contacts, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.READ_CALENDAR, R.string.common_permission_calendar);
        PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_CALENDAR, R.string.common_permission_calendar);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.ACTIVITY_RECOGNITION, activityRecognitionPermissionNameStringId);
        PERMISSION_DESCRIPTION_MAP.put(activityRecognitionPermissionNameStringId, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.ACCESS_MEDIA_LOCATION, R.string.common_permission_access_media_location);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.SEND_SMS, R.string.common_permission_sms);
        PERMISSION_NAME_MAP.put(PermissionConstants.RECEIVE_SMS, R.string.common_permission_sms);
        PERMISSION_NAME_MAP.put(PermissionConstants.READ_SMS, R.string.common_permission_sms);
        PERMISSION_NAME_MAP.put(PermissionConstants.RECEIVE_WAP_PUSH, R.string.common_permission_sms);
        PERMISSION_NAME_MAP.put(PermissionConstants.RECEIVE_MMS, R.string.common_permission_sms);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_sms, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.GET_INSTALLED_APPS, R.string.common_permission_get_installed_apps);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_get_installed_apps, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.MANAGE_EXTERNAL_STORAGE, R.string.common_permission_all_file_access);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_all_file_access, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.REQUEST_INSTALL_PACKAGES, R.string.common_permission_install_unknown_apps);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.SYSTEM_ALERT_WINDOW, R.string.common_permission_display_over_other_apps);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.WRITE_SETTINGS, R.string.common_permission_modify_system_settings);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.NOTIFICATION_SERVICE, R.string.common_permission_allow_notifications);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.POST_NOTIFICATIONS, R.string.common_permission_post_notifications);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_post_notifications, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.BIND_NOTIFICATION_LISTENER_SERVICE, R.string.common_permission_allow_notifications_access);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.PACKAGE_USAGE_STATS, R.string.common_permission_apps_with_usage_access);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.SCHEDULE_EXACT_ALARM, R.string.common_permission_alarms_reminders);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_alarms_reminders, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.ACCESS_NOTIFICATION_POLICY, R.string.common_permission_do_not_disturb_access);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS, R.string.common_permission_ignore_battery_optimize);
        ...
        PERMISSION_NAME_MAP.put(PermissionConstants.BIND_VPN_SERVICE, R.string.common_permission_vpn);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_vpn, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.PICTURE_IN_PICTURE, R.string.common_permission_picture_in_picture);
        PERMISSION_DESCRIPTION_MAP.put(R.string.common_permission_picture_in_picture, R.string.common_permission_description_demo);

        PERMISSION_NAME_MAP.put(PermissionConstants.USE_FULL_SCREEN_INTENT, R.string.common_permission_full_screen_notifications);
