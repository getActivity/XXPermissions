...
-   रिमोट वेयरहाउस को कॉन्फ़िगर करने के बाद, प्रोजेक्ट ऐप मॉड्यूल के तहत`build.gradle`फ़ाइल में दूरस्थ निर्भरताएँ जोड़ें
...
#### अनुमति निगरानी कॉलबैक पैरामीटर विवरण के बारे में
...
-   ढांचा पहले कॉल करेगा**पर अस्वीकृत**विधि, फिर कॉल करें**ऑन ग्रांटेड**तरीका। जिनमें से हम पास कर सकते हैं**ऑन ग्रांटेड**विधि में**सब**पैरामीटर यह निर्धारित करने के लिए कि क्या सभी अनुमतियां दी गई हैं।

-   यदि आप जानना चाहते हैं कि कॉलबैक में अनुमति दी गई है या अस्वीकार की गई है, तो आप कॉल कर सकते हैं**सूची**कक्षा में**शामिल है (अनुमति। XXX)**यह निर्धारित करने की विधि कि सेट में यह अनुमति है या नहीं।

## [अन्य अक्सर पूछे जाने वाले प्रश्नों के लिए, कृपया यहां क्लिक करें](HelpDoc.md)

#### समान अनुमति अनुरोध ढांचे के बीच तुलना

|                        अनुकूलन विवरण                        |                                   [XXअनुमतियाँ](https://github.com/getActivity/XXPermissions)                                  |                                    [औरअनुमति](https://github.com/yanzhenjie/AndPermission)                                   |                                   [अनुमतिX](https://github.com/guolindev/PermissionX)                                  |                            [एंड्रॉइड यूटी आईएल कोड](https://github.com/Blankj/AndroidUtilCode)                           |                                         [अनुमतियाँ डिस्पैचर](https://github.com/permissions-dispatcher/PermissionsDispatcher)                                        |                                [आरएक्सअनुमतियां](https://github.com/tbruyelle/RxPermissions)                               |                                   [आसान अनुमतियां](https://github.com/googlesamples/easypermissions)                                   |
| :---------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------: |
...
-   जांच की प्रक्रिया: कोड को ट्रेस करने के बाद पता चलता है कि कोड कॉल स्टैक इस प्रकार है
    ...
    -   AppOpsManager.startदेखनाशुरू हुआ
...
-   ढांचे के दैनिक रखरखाव में, कई लोगों ने मुझे बताया है कि ढांचे में बग हैं, लेकिन जांच और स्थिति के बाद, यह पाया गया है कि 95% समस्याएं कॉलर के कुछ अनियमित संचालन के कारण होती हैं, जो न केवल मुझे बहुत सारी समस्याओं का कारण बना। परेशानी, और कई दोस्तों के समय और ऊर्जा की एक बड़ी बर्बादी, इसलिए मैंने ढांचे में बहुत सारे समीक्षा तत्व जोड़े, में**डिबग मोड**、**डिबग मोड**、**डिबग मोड**एक बार जब कुछ संचालन विनिर्देश के अनुरूप नहीं होते हैं, तो ढांचा सीधे कॉलर को अपवाद फेंक देगा, और अपवाद जानकारी में त्रुटि को ठीक करने के लिए कॉलर को सही ढंग से मार्गदर्शन करेगा, उदाहरण के लिए:
    ...
    -   यदि कॉलर बिना किसी अनुमति के अनुमति के लिए आवेदन करता है, तो ढांचा एक अपवाद फेंक देगा, या यदि कॉलर द्वारा पारित अनुमतियां खतरनाक अनुमतियां या विशेष अनुमतियां नहीं हैं, तो ढांचा भी अपवाद फेंक देगा, क्योंकि कुछ लोग सामान्य का उपयोग करेंगे अनुमतियां जब ढांचे को खतरनाक अनुमति दी जाती है, तो सिस्टम सीधे इसे अस्वीकार कर देगा।
    ...
    -   यदि वर्तमान परियोजना विभाजन भंडारण के लिए उपयुक्त नहीं है, तो इसके लिए आवेदन करें`READ_EXTERNAL_STORAGE`तथा`WRITE_EXTERNAL_STORAGE`अनुमति
        ...
        -   जब परियोजना`targetSdkVersion >= 29`, इसे मेनिफेस्ट फ़ाइल में पंजीकृत करने की आवश्यकता है`android:requestLegacyExternalStorage="true"`विशेषता, अन्यथा ढांचा एक अपवाद फेंक देगा। यदि नहीं, तो यह एक समस्या पैदा करेगा। जाहिर है, भंडारण की अनुमति प्राप्त कर ली गई है, लेकिन बाहरी भंडारण पर फ़ाइलों को सामान्य रूप से एंड्रॉइड 10 डिवाइस पर पढ़ा और लिखा नहीं जा सकता है।

        -   जब परियोजना`targetSdkVersion >= 30`, आप आवेदन नहीं कर सकते`READ_EXTERNAL_STORAGE`तथा`WRITE_EXTERNAL_STORAGE`अनुमति, लेकिन इसके लिए आवेदन करना चाहिए`MANAGE_EXTERNAL_STORAGE`अनुमति

        -   यदि वर्तमान परियोजना को विभाजन भंडारण के लिए अनुकूलित किया गया है, तो आपको केवल मेनिफेस्ट फ़ाइल में मेटा-डेटा विशेषता पंजीकृत करने की आवश्यकता है:`<meta-data android:name="ScopedStorage" android:value="true" />`
    ...
    -   यदि अनुरोधित अनुमति और परियोजना की**लक्ष्यएसडीकेसंस्करण**नहीं, ढांचा एक अपवाद फेंकता है क्योंकि**लक्ष्यएसडीकेसंस्करण**यह दर्शाता है कि परियोजना को किस Android संस्करण के लिए अनुकूलित किया गया है, और सिस्टम स्वचालित रूप से पश्चगामी संगतता बना देगा। यह माना जाता है कि इसके लिए लागू अनुमतियाँ केवल Android 11 में उपलब्ध हैं, लेकिन**लक्ष्यएसडीकेसंस्करण**अभी भी 29 पर रहना, फिर कुछ मॉडलों पर आवेदन में एक प्राधिकरण अपवाद होगा, अर्थात, उपयोगकर्ता ने स्पष्ट रूप से अधिकृत किया है, लेकिन सिस्टम हमेशा गलत लौटाता है।

    -   यदि गतिशील रूप से अनुरोधित अनुमति नहीं है`AndroidManifest.xml`यदि आप ऐसा नहीं करते हैं, तो आप अनुमति के लिए आवेदन कर सकते हैं, लेकिन प्राधिकरण पॉप-अप विंडो दिखाई नहीं देगी, और इसे सिस्टम द्वारा सीधे अस्वीकार कर दिया जाएगा, और सिस्टम कोई पॉप-अप विंडो और संकेत नहीं देगा, और यह हर मॉडल पर समस्या**देखना होगा**。

    -   यदि गतिशील रूप से अनुरोधित अनुमति है`AndroidManifest.xml`में पंजीकृत है, लेकिन एक अनुपयुक्त`android:maxSdkVersion`संपत्ति मूल्य, ढांचा एक अपवाद फेंक देगा, उदाहरण के लिए:`<uses-permission android:name="xxxx" android:maxSdkVersion="29" />`, ऐसी सेटिंग के परिणामस्वरूप Android 11 (`Build.VERSION.SDK_INT >= 30`) और इसके बाद के संस्करण अनुमति के लिए आवेदन करने के लिए, सिस्टम विचार करेगा कि यह अनुमति मेनिफेस्ट फ़ाइल में पंजीकृत नहीं है, और सीधे इस अनुमति आवेदन को अस्वीकार कर देगा, और कोई पॉप-अप विंडो और संकेत नहीं देगा। यह समस्या भी अपरिहार्य है।

    -   यदि आप एक ही समय में आवेदन करते हैं`MANAGE_EXTERNAL_STORAGE`、`READ_EXTERNAL_STORAGE`、`WRITE_EXTERNAL_STORAGE`इन तीन अनुमतियों के लिए, फ्रेमवर्क एक अपवाद फेंक देगा, आपको एक ही समय में इन तीन अनुमतियों के लिए आवेदन न करने के लिए कहेगा, ऐसा इसलिए है क्योंकि एंड्रॉइड 11 और ऊपर के उपकरणों पर, एप्लिकेशन`MANAGE_EXTERNAL_STORAGE`अनुमति, कोई आवेदन नहीं`READ_EXTERNAL_STORAGE`、`WRITE_EXTERNAL_STORAGE`अनुमति आवश्यक है, ऐसा इसलिए है क्योंकि आवेदन`MANAGE_EXTERNAL_STORAGE`अनुमति से अधिक होने के बराबर है`READ_EXTERNAL_STORAGE`、`WRITE_EXTERNAL_STORAGE`अधिक शक्तिशाली क्षमताएं, यदि आप ऐसा करने पर जोर देते हैं, तो यह प्रतिकूल होगा। यह मानते हुए कि ढांचा अनुमति देता है, एक ही समय में दो प्राधिकरण विधियां होंगी, एक पॉप-अप विंडो प्राधिकरण है, और दूसरा जंप पेज प्राधिकरण है उपयोगकर्ता को दो प्राधिकरण करने होते हैं। लेकिन वास्तव में वहाँ है`MANAGE_EXTERNAL_STORAGE`उपयोग के लिए अनुमति पर्याप्त है। इस समय, आपके मन में एक प्रश्न हो सकता है। आप आवेदन न करें।`READ_EXTERNAL_STORAGE`、`WRITE_EXTERNAL_STORAGE`अनुमतियां, Android 11 के नीचे नहीं`MANAGE_EXTERNAL_STORAGE`क्या इस अनुमति में कोई समस्या नहीं होगी? आप इस मुद्दे के बारे में निश्चिंत हो सकते हैं, यदि आप आवेदन करते हैं तो ढांचा निर्णय करेगा`MANAGE_EXTERNAL_STORAGE`Android 11 के नीचे के फ़्रेमवर्क में अनुमतियां अपने आप जुड़ जाएंगी`READ_EXTERNAL_STORAGE`、`WRITE_EXTERNAL_STORAGE`आवेदन करने के लिए आओ, इसलिए निचले संस्करण में अनुमतियों की कमी के कारण यह अनुपलब्ध नहीं होगा।

    -   यदि आपको उपरोक्त परीक्षणों की आवश्यकता नहीं है, तो आप कॉल कर सकते हैं`unchecked`बंद करने की विधि, लेकिन यह ध्यान दिया जाना चाहिए कि मैं आपको इस पहचान को बंद करने की अनुशंसा नहीं करता, क्योंकि में**रिलीज मोड**जब यह बंद हो जाता है, तो आपको इसे मैन्युअल रूप से बंद करने की आवश्यकता नहीं होती है, और यह केवल में है**डिबग मोड**इन डिटेक्शन को केवल ट्रिगर किया जाएगा।
...
-   जब अनुमति आवेदन में कोई समस्या होती है, तो क्या आप चाहते हैं कि कोई आपको याद दिलाने के लिए आए और आपको बताए कि क्या गलत हुआ? इसे कैसे ठीक करें? हालांकि, इन XXअनुमतियों ने इसे किया है। सभी अनुमति अनुरोध ढांचे में से, मैं ऐसा करने वाला पहला व्यक्ति हूं, मुझे लगता है**एक फ्रेम बनाओ**यह न केवल कार्यों का अच्छा काम करने और जटिल परिदृश्यों को संभालने के लिए है, बल्कि इससे भी महत्वपूर्ण बात यह है कि**लोगों को उन्मुख**, क्योंकि ढांचा ही लोगों की सेवा करने के लिए है, हमें जो करना है वह न केवल सभी की जरूरतों को हल करने के लिए है, बल्कि इस प्रक्रिया में चक्कर लगाने से बचने में सभी की मदद करने के लिए भी है।
...
-   पिछड़ी संगत विशेषताएं: पुरानी प्रणाली में सामान्य रूप से नई अनुमतियां लागू की जा सकती हैं, और कॉलर को अनुकूलित करने की आवश्यकता के बिना ढांचा स्वचालित रूप से अनुकूलित हो जाएगा
